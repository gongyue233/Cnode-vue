<template>
    <div id="novice" class="panel">
        <div class="header">
            <router-link :to="{name:'root'}">主页</router-link> / Node.js 新手入门
        </div>
        <div class="content"> 
        <div class="markdown-text inner">
            <h2>Node.js 入门</h2>
            <p><strong>《汇智网 Node.js 课程》</strong></p>
            <p>
                <a href="http://www.hubwiz.com/course/?type=nodes" target="_blank">
            ...
            <p><strong>《Node入门-一本全面的Node.js教程》</strong></p>
            <p>
                <a href="http://www.nodebeginner.org/index-zh-cn.html" target="_blank">http://www.nodebeginner.org/index-zh-cn.html</a>
            </p>
            <h2>Node.js 资源</h2>
            ...
            <p>《<strong>node123-node.js中文资料导航</strong>》</p>
            <p>
            ...
            <p>
               <a href="https://github.com/cnodejs/nodeclub/wiki/%E5%90%8D%E4%BA%BA%E5%A0%82" target="_blank">https://github.com/cnodejs/nodeclub/wiki/名人堂</a>
            </p>
            <h2>Node.js 服务器</h2>
            <p>
               新手搭建 Node.js 服务器，推荐使用无需备案的 
               <a href="https://www.digitalocean.com/?refcode=eba02656eeb3" target="_blank">DigitalOcean(https://www.digitalocean.com/)</a>
            </p>   
        </div>
        </div>
    </div>
